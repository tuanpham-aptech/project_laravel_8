    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="collection-item big">
                    <img src="{{asset('assets/images/bai-viet-ve-noi-that-phong-khach-va-cach-trang-tri-doc-dao-2.jpg')}}" alt="">
                    <div class="collection-info">
                        <h4>Nội thất phòng khách  </h4>
                        <p>Những mẫu nội thất mới nhất cho phòng khách của bạn trong hè này</p>
                        <button class="button btnleft">Xem Ngay</button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="row">
                    <div class="col-sm-6 col-xs-6 col-md-6 col-6">
                        <div class="collection-item">
                            <img src="{{asset('assets/images/ban-an-gap.jpg')}}" alt="">
                            <div class="collection-info">
                                <h4>Bàn ăn </h4>
                                <p>Những bàn ăn phổ biến nhất</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-6 col-6">
                        <div class="collection-item">
                            <img src="{{asset('assets/images/ban-an-thong-minh-1.png')}}" alt="">
                            <div class="collection-info">
                                <h4>Bàn ăn </h4>
                                <p>Mẫu bàn ăn nổi bật</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-6 col-6">
                        <div class="collection-item">
                            <img src="{{asset('assets/images/ban-ghe-phong-ngu-8.jpg')}}" alt="">
                            <div class="collection-info">
                                <h4>Bộ bàn ghế </h4>
                                <p>Bộ bàn ghế phòng ngủ </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-6 col-6">
                        <div class="collection-item">
                            <img src="{{asset('assets/images/nghe-thuat-tao-phong-khach.jpg')}}" alt="">
                            <div class="collection-info">
                                <h4>Phòng khách </h4>
                                <p>Nghệ thuật tạo phòng khách </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-3 col-md-3">
                                <div class="product-block">
                                    <div class="product-img">
                                        <a href="{{route('product-detail',[$pro->pro_slug,$pro->id])}}">
    ...
    <div class="container">
        <div class="row">
           ...
           <div class="col-md-12 col-sm-12">
            <div class="tab-content">
                <div class="row">
                    @foreach ($prohots as $proat)
                    <div class="col-sm-3 col-md-3">
                        <div class="product-block">
                            <div class="product-img">
                                <a href="{{route('product-detail',[$proat->pro_slug,$proat->id])}}">
                                    <img src="{{url('myuploads/'.$proat->pro_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product-info">
                                <a href="{{route('product-detail',[$proat->pro_slug,$proat->id])}}">
                                    <h4 class="product-title">{{$proat->pro_name}}</h4>
                                </a>
                                <p>{{$proat->pro_price}}</p>
                                <a href="{{route('product-detail',[$pro->pro_slug,$pro->id])}}" class="button"> Xem thêm </a>
                            </div>
